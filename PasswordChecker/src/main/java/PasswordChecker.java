...
public class PasswordChecker extends Exception{

    public boolean passwordIsValid(String psswrd) throws Exception{
            ...
            for(int d=0; d<changeit.length; d++){
                if(Character.isDigit(changeit[d])){
                    if(match.find()) {
                        ...
                        throw new Exception("your password is in valid");
                     }
            }else{
